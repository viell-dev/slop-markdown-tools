...
Configurable linting and formatting for CommonMark, GitHub Markdown, Forgejo
(Codeberg), and Obsidian. Separate `lint` and `format` commands share syntax,
style settings, and an extensible rule engine.
